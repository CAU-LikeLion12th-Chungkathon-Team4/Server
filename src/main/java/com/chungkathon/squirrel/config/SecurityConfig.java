    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((auth) -> {
                    ...
                    auth.requestMatchers("/dotoricollection/{urlRnd:[a-zA-Z0-9\\\\-]+}").permitAll();
                    ...
                    auth.requestMatchers("/dotoricollection/{dotori_collection_id:[a-zA-Z0-9\\\\-]+}/quiz").authenticated();
                    ...
                    auth.requestMatchers("/dotoricollection/{urlRnd:[a-zA-Z0-9\\\\-]+}/isFull").permitAll();
