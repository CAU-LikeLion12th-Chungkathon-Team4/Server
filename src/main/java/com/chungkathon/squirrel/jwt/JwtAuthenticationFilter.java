...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private static final String[] EXCLUDED_PATHS = {"/join", "/login", "/api/v1/check", "/join/check", "h2-console",};
    private static final String[] DYNAMIC_PATH_PATTERN = {"^/dynamic/[a-zA-Z0-9\\-]+$", "^/dotoricollection/[a-zA-Z0-9\\-]+$",
            "^/dotoricollection/[a-zA-Z0-9\\-]+$/create", "^/dotoricollection/[a-zA-Z0-9\\-]+$/quiz", "^/dotoricollection/[a-zA-Z0-9\\-]+$/reply", "/dotoricollection/[a-zA-Z0-9\\-]+$/open"};
